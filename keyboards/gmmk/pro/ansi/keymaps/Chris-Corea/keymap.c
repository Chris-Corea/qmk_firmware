...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, RGB_TOG, RGB_M_P, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_MPLY,
...
void rgb_matrix_indicators_user(void) {
    ...
    if (led_state.caps_lock) {
      rgb_matrix_set_color_all(0xF1, 0x94, 0x8A);
    }
}
